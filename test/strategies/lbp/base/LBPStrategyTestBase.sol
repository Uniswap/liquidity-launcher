...
abstract contract LBPStrategyTestBase is Test {
    ...
    uint256 constant RECOVERY_DELAY = 7_200;
    ...
    function setUp() public virtual {
        ...
        bytes memory constructorArgs =
            abi.encode(POSITION_MANAGER, POOL_MANAGER, IDistributionStrategy(address(factory)), owner, RECOVERY_DELAY);
        ...
        strategy = new LBPStrategy{salt: salt}(
            POSITION_MANAGER, POOL_MANAGER, IDistributionStrategy(address(factory)), owner, RECOVERY_DELAY
        );
