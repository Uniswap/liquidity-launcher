...
contract DeployAdvancedLBPStrategyFactoryMainnetScript is Script {
    ...
    function run() public {
        ...
        AdvancedLBPStrategyFactory factory =
            new AdvancedLBPStrategyFactory{salt: salt}(IPositionManager(POSITION_MANAGER), IPoolManager(POOL_MANAGER));
