...
struct MigrationData {
    ...
    uint256 initialTokenAmount; // the initial token amount for the full range position
    uint256 leftoverCurrency; // the leftover currency (if any) after creating the full range position
    uint256 initialCurrencyAmount; // the initial currency amount for the full range position
