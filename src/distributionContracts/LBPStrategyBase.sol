...
abstract contract LBPStrategyBase is ILBPStrategyBasic, HookBasic {
    ...
    function _getTokenTransferAmount(MigrationData memory data) internal view virtual returns (uint256) {}

    /// @notice Calculates the amount of currency to transfer
    /// @param data Migration data
    /// @return The amount of currency to transfer to the position manager
    function _getCurrencyTransferAmount(MigrationData memory data) internal pure virtual returns (uint256) {}
